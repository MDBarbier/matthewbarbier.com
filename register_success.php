...
<html>
	<head>
		<title>matthewbarbier.com registration success</title>
	...
	<body>
		...
		<div class="voffset10" id="header">
			<h1 class="banner title-banner">matthewbarbier.com</h1>
		</div>
    ...
    <div class="row main-content">
        ...
        <div class="col-md-8">
         ...
         <p>You can now go back to the login page and log in with your credentials.</p>

         <div onclick="window.location.href='login'" style="cursor:pointer;"><p>Click here to go to the log in page.</p></div>
